...
HEARTBEAT_STALE_MINUTES = int(os.environ.get("OPENCLAW_HEARTBEAT_STALE_MINUTES", "30"))
ERROR_RATE_THRESHOLD = float(os.environ.get("OPENCLAW_AGENT_ERROR_RATE_THRESHOLD", "0.05"))  # 5%
