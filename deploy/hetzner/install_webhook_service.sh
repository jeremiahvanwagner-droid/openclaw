...
resolved_gateway_token="${OPENCLAW_GATEWAY_AUTH_TOKEN:-${OPENCLAW_GATEWAY_TOKEN:-}}"
upsert_env "OPENCLAW_GATEWAY_AUTH_TOKEN" "${resolved_gateway_token}"
upsert_env "OPENCLAW_GATEWAY_TOKEN" "${resolved_gateway_token}"
