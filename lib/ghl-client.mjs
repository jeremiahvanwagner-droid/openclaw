...
/**
 * Migration shim: re-export the v2 client for callers ready to upgrade.
 * Existing callers using createGhlClient() continue working unchanged.
 */
export { createGhlClientV2 } from './ghl-client-v2.mjs';
