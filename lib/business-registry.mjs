...
export function classifyBusinessTenancy(tenancyInputs = {}, requestedScopeType = "auto") {
  ...
  if (requestedScopeType && requestedScopeType !== "auto") {
    const scopeFamily = requestedScopeType.startsWith("dedicated")
      ? "dedicated"
      : requestedScopeType.startsWith("internal")
        ? "internal"
        : "shared";
    return {
      scope_family: scopeFamily,
      ghl_scope_type: requestedScopeType,
      reasons,
